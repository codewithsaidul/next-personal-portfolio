    ...
    <>
      ...
      <header className="sticky top-0 z-50">
        <div className="flex items-center justify-between rounded-2xl bg-white p-3 shadow dark:bg-black dark:shadow-dark">
          ...
          <Link
            href="/"
            className="inline-flex items-center gap-3 px-3 text-2xl max-[350px]:text-lg font-semibold text-dark dark:text-white"
          >
            <span>
          ...
          <div className="hidden items-center gap-4 lg:flex">
            ...
            <a
              href="contact.html"
              className="inline-flex max-[1140px]:hidden items-center gap-2 rounded-lg bg-dark px-6 py-4 text-center text-base font-semibold leading-tight text-white transition hover:bg-primary dark:bg-dark-2 dark:text-white dark:hover:bg-primary dark:hover:text-white"
            >
      ...
      {/* <!-- Mobile menu --> */}
      <div
        className={`fixed bottom-0 start-0 top-0 z-[60] h-full w-64  transform ${
          open ? "hs-overlay-open:translate-x-0" : "-translate-x-full"
        } overflow-y-auto bg-white transition-all duration-300  dark:bg-black [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-gray-300 [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar]:w-2`}
      >
