...
const MobileNavbar = () => {
  ...
  return (
    <>
      {/* <!-- Mobile menu --> */}
      <div
        className={`fixed bottom-0 start-0 top-0 z-[60] h-full w-64  transform ${open ? 'hs-overlay-open:translate-x-0' : '-translate-x-full'} overflow-y-auto bg-white transition-all duration-300  dark:bg-black [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-gray-300 [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar]:w-2`}
      >
